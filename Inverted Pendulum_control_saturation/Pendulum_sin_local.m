...
domain1 = [-10, 10, -10, 10];
[C,h] = pcontour(V,1,domain1,'r',[200, 200]);
...
ah = [];
ah(1)=annotation('textarrow',[0.41 0.35],[0.85 0.85],'String','$\{x:\underline{v}^1 \leq v^1 \leq \bar{v}^1\}$','interpreter','latex');
ah(2)=annotation('textarrow',[0.5 0.42],[0.18 0.35],'String','$\{x:\underline{\theta} \leq \theta \leq \bar{\theta}\}$','interpreter','latex');
set(ah,'FontSize',18)
